      ...
      if (docSnap.exists()) {
        ...
        if (profileData.rankingOptIn) {
          ...
          await setDoc(rankingRef, {
            ...
            maintenanceMonth: data.maintenanceMonth !== undefined ? data.maintenanceMonth : profileData.maintenanceMonth || "",
            annualIpva: data.annualIpva !== undefined ? data.annualIpva : profileData.annualIpva || 0,
            annualLicensing: data.annualLicensing !== undefined ? data.annualLicensing : profileData.annualLicensing || 0,
            ipvaYear: data.ipvaYear !== undefined ? data.ipvaYear : profileData.ipvaYear || "",
            licensingYear: data.licensingYear !== undefined ? data.licensingYear : profileData.licensingYear || "",
